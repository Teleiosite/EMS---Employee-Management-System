...
import { Upload, X, AlertCircle, Download, Loader2, CheckCircle2, AlertTriangle } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-in fade-in transition-all font-sans">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar">
          {/* Fatal error state — entire upload failed */}
          {importError && !importResult && (
            <div className="text-center space-y-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-gray-900 mb-1">Upload Failed</h4>
                <p className="text-sm text-red-600 bg-red-50 rounded-xl p-3 text-left leading-relaxed">{importError}</p>
              </div>
              <button
                onClick={onDone}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-orange-50/80 border border-orange-100 p-4 rounded-xl space-y-2">
                ...
                <p className="text-xs text-orange-700/80 leading-relaxed">
                  Required columns (exact names): <span className="font-semibold">First Name, Last Name, Email, Department, Designation, Base Salary, Employee ID, Joining Date</span>.
                </p>
                <div className="pt-2">
                  <button
                    type="button"
