          ...
          <div className="grid gap-4">
            {filteredJobs.length === 0 ? (
              ...
              filteredJobs.map(job => (
                <div key={job.id} className={`border border-gray-100 rounded-lg p-5 hover:bg-gray-50 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4 ${deleting === job.id ? 'opacity-50' : ''}`}>
